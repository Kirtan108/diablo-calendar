...
const { deleteOldThreads } = require("./utils/functions")
const { deleteOldMatches } = require("./mongo/functions")
const createMatchAndGroups = require('./match/createMatchAndGroups')
